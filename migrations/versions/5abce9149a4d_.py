...
Revision ID: 5abce9149a4d
Revises: None
Create Date: 2019-10-15 09:25:45.178602

"""

# revision identifiers, used by Alembic.
revision = '5abce9149a4d'
down_revision = None
...
def upgrade():
    ...
    op.create_table('teplota',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('teplota', sa.Integer(), nullable=False),
    sa.Column('cas_insertu', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id', name='pk_teplota'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_teplota_teplota', 'teplota', ['teplota'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_teplota_teplota', table_name='teplota')
    op.drop_table('teplota')
